...
const makeMessagesRecvSocket = (config) => {
    ...
    const processMessageLocal = async (msg) => {
        ...
        const newEvents = await process_message_1.default(msg, { historyCache, meId, accountSettings: authState.creds.accountSettings, keyStore: authState.keys, logger, treatCiphertextMessagesAsReal });
